...
function normalizePayload(job: Record<string, unknown>) {
  ...
  return {
    ...
    tableDisplayName: cleanText((payload as Record<string, unknown>).tableLabel || (payload as Record<string, unknown>).table_label || (job as Record<string, unknown>).table_label || (job as Record<string, unknown>).tableLabel || (payload as Record<string, unknown>).tableDisplayName || (payload as Record<string, unknown>).locationName || ""),
...
function normalizeJob(job: Record<string, unknown>) {
  ...
  return {
    ...
    tableDisplayName: cleanText((job as Record<string, unknown>).table_label || (job as Record<string, unknown>).tableLabel || (payload as Record<string, unknown>).tableLabel || (payload as Record<string, unknown>).table_label || (payload as Record<string, unknown>).tableDisplayName || (payload as Record<string, unknown>).locationName || ""),
